  ...
  async.waterfall([
    ...
    function(token, done) {
      ...
      User.findOne({ email: req.body.email }, (err, user) => {
        if (err) throw err;
        if (!user) {
          req.flash("error", "That Foodies-Corner account doesn't exist.");
    ...
    function(token, user, done) {
      ...
      let smtpTransport = nodemailer.createTransport({
        service: "Gmail",
        auth: {
          user: "dsstrrhl@gmail.com",
          pass: process.env.PASSWORD
        }
      });
      let mailOptions = {
        from: "dsstrrhl@gmail.com",
        to: user.email,
        subject: "Reset your Foodies-Corner Password",
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      let mailOptions = {
        from: "dsstrrhl@gmail.com",
        to: user.email,
        subject: "Your Foodies-Corner Password has been changed",
        text: "Hi " + user.firstName + ",\n\n" +
